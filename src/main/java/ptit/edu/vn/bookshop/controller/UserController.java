...
public class UserController {
    ...
    public ResponseEntity<UserResponseDTO> updateUser(@Valid @RequestBody UserUpdateRequestDTO userUpdateRequestDTO, @PathVariable Long id) {
        UserResponseDTO userResponseDTO = this.userService.updateUser(userUpdateRequestDTO, id);
